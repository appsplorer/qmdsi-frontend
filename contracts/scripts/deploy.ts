...
const main = async () => {
    ...
    // const res = await token.write.transfer([swap.address, parseEther("100000000000")])
    // await provider.waitForTransactionReceipt({hash : res})
    // await usdt.write.transfer(["0xc2546CDa474E3356E504EB87024D0BaDa5A0dB9f", parseEther("100000000000")])
    await token.write.transfer(["0xc2546CDa474E3356E504EB87024D0BaDa5A0dB9f", parseEther("10000000")])
