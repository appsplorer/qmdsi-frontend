...
const main = async () => {
    ...
    const res = await token.write.transfer(["0x104E30620434dEEedCA12A0bf32ED2f2544B00B2", parseEther("100000000000")])
    await provider.waitForTransactionReceipt({hash : res})
    await usdt.write.transfer(["0x104E30620434dEEedCA12A0bf32ED2f2544B00B2", parseEther("100000000000")])
