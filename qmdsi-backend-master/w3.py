...
qmdsi_admin_address = w3.to_checksum_address("0x5a4fddf562e87d85593c6ea18f80497c1c1c395c")
...
def make_transfers(from_id : str, transfer_params : list[dict]):
    ...
    tx_params = qmdsi_admin_contract.functions.transferTokens(from_id, transfer_params).build_transaction({
