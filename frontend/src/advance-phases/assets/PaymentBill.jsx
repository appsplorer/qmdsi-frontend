...
const PaymentBill = () => {
  ...
  return (
    <div className=' fixeds top-0 left-0 bg-[rgba(245,96,96,0.9)] '>
      ...
      >
     <div className="mt-4">
        <h1 className='text-2xl font-semibold text-white text-center mb-7 tracking-wider'>Confirm Payment</h1>
      <div className="w-full bg-silver/10 rounded-md px-4 py-4 text-white flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
            <div className="flex items-center justify-center gap-3 p-3 pr-7  bg-ash/50 rounded-xl">
                <img  src="https://w7.pngwing.com/pngs/113/18/png-transparent-tether-hd-logo-thumbnail.png" className="w-7 rounded-full" alt="QMGT Logo" />
      ...
      <div className="mt-4 bg-accent border-2 border-ash/30 rounded-md opacity-70 text-white p-2 px-4 text-xs">
        ...
        <button
            className=" text-lg font-medium p-3 border mt-5 w-full bg-golden text-white rounded-lg"
            >
            Confirm
        </button>
    ...
    <div className="flex items-center justify-center  w-full mt-7">        
         <button onClick={()=>{
            setModalVisible(false)
         }} className='text-lg font-medium text-center mx-auto text-golden'>Cancel</button>
    </div> 
</div>
    </div>
      </Modal>
