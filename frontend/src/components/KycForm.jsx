            ...
            <form onSubmit={handleImageUploadSubmit} className="space-y-6">
              <div className="w-full">
                ...
                <input
                  ...
                  className="file-input w-full px-4 py-2 text-gray-700 border border-gray-300 rounded-lg focus:outline-none focus:ring-primary focus:border-primary transition duration-150 ease-in-out"
                />
              </div>
              ...
              <button
                type="submit"
                className="bg-primary text-white p-3 rounded-lg w-full font-semibold transition duration-150 ease-in-out"
              >
                Upload Documents
              </button>
            </form>
